...
router.post(`/signup`, async (req, res) => {
    const { name, phone, email, password, isAdmin, isBroker } = req.body;
...
router.post(`/authWithGoogle`, async (req, res) => {
    const { name, phone, email, password, images, isAdmin, isBroker } = req.body;
    ...
    try {
        ...
        const user = await User.findByIdAndUpdate(
            req.params.id,
            {
                ...
                password: newPassword,
                images: imagesArr.length ? imagesArr : userExist.images,
                isAdmin: isAdmin !== undefined ? isAdmin : userExist.isAdmin,
                isBroker: isBroker !== undefined ? isBroker : userExist.isBroker,
            },
            { new: true }
        );
