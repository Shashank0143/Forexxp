...
const Listing = ({ params }) => {
    ...
    useEffect(() => {
        ...
        let apiEndPoint = `/api/products/catSlug?catSlug=${id}&location=${localStorage.getItem("location")}&page=1&perPage=8`;
    ...
    const filterData = (catId) => {
        ...
        fetchDataFromApi(`/api/products/catSlug?catSlug=${catId}&location=${localStorage.getItem("location")}&page=1&perPage=8`).then((res) => {
            setProductData(res);
            setisLoading(false);
        })
    }
